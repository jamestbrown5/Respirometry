---
title: "Respirometry BE: Return to Non Diapause Conditions"
...
##Set "syringe" and "treat"" identifier as a number
dataBE$syringe=as.numeric(dataBE$syringe)
dataBE$treat=as.numeric(dataBE$treat)
...
dataBE=subset(dataBE, dataBE$stage!="Pre")
dataBE=subset(dataBE, dataBE$treat!="1")
dataBE=subset(dataBE, dataBE$treat!="2")
`````
