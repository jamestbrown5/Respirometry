...
ggplot(dataBEUZ, aes(x=day, fill=stage))+
  geom_density(alpha=.3)+
...
dataBEUZmassf=subset(dataBEUZmass,treat=="1"|treat=="2")
ggplot(data=dataBEUZmassf,aes(x=day,y=mass,group=treat,color=treat))+
  stat_summary(fun.y=mean, geom="line")+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.05) +
  theme_classic()+
  scale_x_continuous(breaks=pretty(dataBEUZmassf$day, n=30))+
  ggtitle("Change in Mass Production")+
  ylab("Mass")+xlab("Day")

ggplot(data=dataBEUZmass12,aes(x=day,y=mass,group=strain,color=strain))+
  stat_summary(fun.y=mean, geom="line")+
  facet_grid(strain~treat)+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.05) +
  theme_classic()+
  ...
  scale_x_continuous(breaks=pretty(dataBEUZmass12$day, n=30))+
  ggtitle("Change in Mass Production")+
  ylab("Mass")+xlab("Day")

ggplot(data=dataBEUZmass16,aes(x=day,y=mass,group=strain,color=strain))+
  stat_summary(fun.y=mean, geom="line")+
  facet_grid(strain~treat)+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.05) +
  theme_classic()+
  ...
  scale_x_continuous(breaks=pretty(dataBEUZmass16$day, n=10))+
  ggtitle("Change in Mass Production")+
  ylab("Mass")+xlab("Day")

datamass16be=subset(dataBEUZmass16,strain=="BE")
datamass16be=subset(datamass16be,day=="3")
datamass16uz=subset(dataBEUZmass16,strain=="UZ")
datamass16uz=subset(datamass16uz,day=="5")
...
datamassbe=subset(datamassbe,day=="6")
datamassuz=subset(dataBEUZmass12,strain=="UZ")
datamassuz=subset(datamassuz,day=="9")
...
ggplot(data=dataBEUZcm,aes(x=day,y=co2_min_mass, color=strain,group=strain))+
  stat_summary(fun.y=mean, geom="line")+
  facet_grid(strain~treat)+
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.05) +
  theme_classic()+
...
dataBEpupa=subset(dataBEres,syringe=="52"|syringe=="53"|syringe=="54"|syringe=="57"|syringe=="59"|syringe=="60"|syringe=="61"|syringe=="63"|syringe=="66"|syringe=="70"|syringe=="71"|syringe=="73"|syringe=="74")
dataBEpupa$term="early"
dataBEres=subset(dataBEres,syringe=="51"|syringe=="56"|syringe=="62"|syringe=="64"|syringe=="68"|syringe=="69"|syringe=="75")
dataBEres$term="late"
...
ggplot(data=massdiff,aes(x=day,y=mass,group=term,color=term))+
  ...
  stat_summary(fun.data=mean_se, geom="errorbar", width=0.05) +
  theme_bw()+
  ggtitle("Early vs Late Terminators")+
...
modq=lm(mass~term,data=Peakmass)
summary(modq)
