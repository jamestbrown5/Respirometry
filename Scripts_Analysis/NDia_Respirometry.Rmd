---
title: "Strain Comparison Non Diapause Treatment"
...
ggplot(data=dataUB,aes(x=day,y=co2_hourly))+
  geom_point()+
  geom_line()+
  ggtitle("UZ and BE Larvae: Non Diapause Treatment")+
  ylab("CO2 production")+
  facet_wrap(~strain)+
...
ggplot(data=dataUB,aes(x=day,y=co2_hourly_mass))+
  ...
  ggtitle("UZ and BE Larvae: Non Diapause Treatment by Mass")+
